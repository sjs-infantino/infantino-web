...
const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container md:pb-10">
      <Heading tag="Tech Milestones: A Look Back at Past Events" title="Our Legacy of Tech Excellence!" />
                ...
                <div className="relative z-1">
                  <div className="flex items-center justify-between max-w-[27rem] mb-8 md:mb-20">
                    ...
                    <div className="flex items-center px-4 py-1 bg-n-1 rounded text-n-8">
                      <img className="mr-2.5" src={check2} width={16} height={16} alt={status}/>
                      <div className="tagline">{status}</div>
                    </div>
                  </div>
                  <div className="mb-10 -my-10 -mx-15 max-md:-mx-0">
      ...
      <div className="flex justify-center mt-12 md:mt-15 xl:mt-20">
        <Button href="/Register">Join Our Next Event</Button>
      </div>
    </div>
  </Section>
);
